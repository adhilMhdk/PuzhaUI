...
let login_buttons = document.getElementsByClassName("login")
...
let cart_buttons = document.getElementsByClassName("cart")
...
let play_buttons = document.getElementsByClassName("play")
...
let pause_buttons = document.getElementsByClassName("pause")
...
let minus_buttons = document.getElementsByClassName("minus")
...
let disabled_buttons = document.getElementsByClassName('disable')
